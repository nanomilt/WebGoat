...
webgoat.customjs.profileUpload = function () {
  ...
  const picture = document.getElementById('uploadedFile') ? document.getElementById('uploadedFile').files[0] : null;
  const formData = new FormData();
  if (picture) {formData.append('uploadedFile', picture);}
...
webgoat.customjs.profileUploadFix = function () {
  const picture = document.getElementById('uploadedFileFix') ? document.getElementById('uploadedFileFix').files[0] : null;
  const formData = new FormData();
  if (picture) {formData.append('uploadedFileFix', picture);}
...
webgoat.customjs.profileUploadRemoveUserInput = function () {
  const picture = document.getElementById('uploadedFileRemoveUserInput') ? document.getElementById('uploadedFileRemoveUserInput').files[0] : null;
  const formData = new FormData();
  if (picture) {formData.append('uploadedFileRemoveUserInput', picture);}
...
webgoat.customjs.profileZipSlip = function () {
  const picture = document.getElementById('uploadedFileZipSlip') ? document.getElementById('uploadedFileZipSlip').files[0] : null;
  const formData = new FormData();
  if (picture) {formData.append('uploadedFileZipSlip', picture);}
