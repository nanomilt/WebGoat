webgoat.customjs.simpleXXE = function () {
    let commentInput = $("#commentInputSimple").val() || ''; // Defining commentInput with a default value
...
webgoat.customjs.contentTypeXXE = function() {
    let commentInput = $("#commentInputContentType").val() || ''; // Defining commentInput with a default value
...
webgoat.customjs.blindXXE = function() {
    let commentInput = $("#commentInputBlind").val() || ''; // Defining commentInput with a default value
    let xml = '<?xml version="1.0"?>' +
        '<comment>' +
        '  <text>' + commentInput + '</text>' +
        '</comment>';
